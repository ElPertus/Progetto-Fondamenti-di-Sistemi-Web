const Home = {     
    ...
    <main>
        ...
        <section>
            ...
            <p class="text-secondary">SEO sta per “Search Engine Optimization.” È la pratica di aumentare sia la qualità che la quantità del <a href="./glossario.html#traffico">traffico</a> del sito Web, nonché l'esposizione al tuo marchio, attraverso risultati dei <a href="#terzo">motori di ricerca</a>                non a pagamento (noti anche come "organici").
        ...
        <section>
            ...
            <p class="text-secondary">Sebbene la pubblicità a pagamento, i <a href="./glossario.html#social">social media</a> e altre piattaforme online possano generare <a href="./glossario.html#traffico">traffico</a> verso i siti Web, la maggior parte del traffico online è guidata
                dai <a href="#terzo">motori di ricerca</a>.
                <br/><br/> I risultati di ricerca <a href="./glossario.html#organico">organici</a> coprono più proprietà digitali, appaiono più credibili agli utenti esperti e ricevono molti più clic rispetto agli annunci a pagamento. Ad esempio, di tutte
        ...
        <section>
            ...
            <p class="text-secondary">I motori di ricerca sono macchine di risposta. Perlustrano miliardi di contenuti e valutano migliaia di fattori per determinare quale contenuto ha maggiori probabilità di rispondere alla tua domanda.
                ...
                in corrispondenza alla <a href="./glossario.html#query">query</a> in un processo denominato “ranking/classifica”.
            </p>
        </section>
        <section>
            ...
            <p class="text-secondary">I motori di ricerca funzionano attraverso tre funzioni principali:
                <br/><br/> Scansione: esplora Internet alla ricerca di contenuti, esaminando il codice/il contenuto per ogni <a href="./glossario.html#url">URL</a> che trovano.
                <br/><br/>Indicizzazione: archivia e organizza i contenuti trovati durante il processo di scansione. Una volta che una pagina è nell'indice, è in esecuzione per essere visualizzata come risultato di <a href="./glossario.html#query">query</a>                pertinenti.
        ...
        <section>
            ...
            <p class="text-secondary">La scansione è il processo di scoperta in cui i motori di ricerca inviano un team di <a href="./glossario.html#bot">bot</a> (noti come crawler o spider) per trovare contenuti nuovi e aggiornati. Il contenuto può variare — potrebbe essere una
                pagina web, un'immagine, un video, un PDF, ecc. — ma indipendentemente dal formato, il contenuto viene scoperto dai link.
                <br/><br/> Googlebot inizia recuperando alcune pagine Web, quindi segue i collegamenti su tali pagine Web per trovare nuovi <a href="./glossario.html#url">URL</a>. Saltando lungo questo percorso di collegamenti, il crawler è in grado di
                trovare nuovo contenuto e aggiungerlo al proprio indice chiamato <a href="./glossario.html#caf">Caffeine</a>, un enorme <a href="./glossario.html#url">database</a> di URL scoperti, per essere successivamente recuperato quando un ricercatore
        ...
        <section>
            ...
            <p class="text-secondary">I motori di ricerca elaborano e archiviano le informazioni che trovano in un indice, un enorme <a href="./glossario.html#url">database</a> di tutti i contenuti che hanno scoperto e che ritengono sufficientemente buoni da essere visualizzati
                dagli utenti.
            </p>
        </section>
        <section>
            ...
            <p class="text-secondary">Quando qualcuno esegue una ricerca, i motori di ricerca setacciano il loro indice alla ricerca di contenuti altamente pertinenti e quindi ordinano quel contenuto nella speranza di risolvere la query del ricercatore. Questo ordinamento dei
                risultati di ricerca per pertinenza è noto come ranking. In generale, puoi presumere che più alto è il ranking di un sito web, più il motore di ricerca ritiene che il sito sia pertinente alla <a href="./glossario.html#query">query</a>.
        ...
        <section>
            ...
            <p class="text-secondary">Per determinare la pertinenza, i motori di ricerca utilizzano <a href="./glossario.html#alg">algoritmi</a>, un processo o una formula mediante il quale le informazioni archiviate vengono recuperate e ordinate in modo significativo. Questi
                ...
                qualità minori, mentre altri sono aggiornamenti di algoritmi principali implementati per affrontare un problema specifico, come Penguin per contrastare lo spam nei <a href="./altro.html">link</a>.
    ...
    <aside>
        <h2>Argomenti</h2>
        <ul>
            <li><a href="#primo">Cos'è una SEO?</a></li>
            <li><a href="#sec">Perché è così importante</a></li>
            <li><a href="#terzo">Motori di Ricerca</a></li>
            <li><a href="#quarto">Come funzionano?</a></li>
            <li><a href="#quinto">Che cos'è la scansione?</a></li>
            <li><a href="#sesto">Che cos'è un indice?</a></li>
            <li><a href="#sett">Classifica sui motori di ricerca</a></li>
            <li><a href="#ott">In che modo classificano gli URL?</a></li>
        </ul>
    </aside>
    `
};
...
const Altro = {     
    ...
    <main>
        ...
        <section>
            ...
            <p class="text-secondary" id="">Quando si parla di link, si possono intendere due cose. I backlink o "link interni" sono collegamenti da altri siti Web che puntano al proprio sito Web, mentre i collegamenti interni sono collegamenti al proprio sito che puntano ad altre pagine
                (sullo stesso sito).
                <br/><br/> I link hanno storicamente svolto un ruolo importante nella SEO. Molto presto, i motori di ricerca avevano bisogno di aiuto per capire quali <a href="./glossario.html#url">URL</a> fossero più affidabili di altri per aiutarli
            ...
            <p class="text-secondary">
                ...
                <br/><br/> Questo è il motivo per cui è stato creato il PageRank. PageRank (parte dell'algoritmo principale di Google) è un <a href="./glossario.html#alg">algoritmo</a> di analisi dei link che prende il nome da uno dei fondatori di Google,
        ...
        <section>
            ...
            <p class="text-secondary">Non avrebbero senso i collegamenti se non indirizzassero i ricercatori a qualcosa. Quel qualcosa è contenuto! Il contenuto è più di semplici parole; è qualsiasi cosa destinata a essere consumata dai ricercatori: ci sono contenuti video, contenuti
                ...
                per una determinata <a href="./glossario.html#query">query</a> è quanto bene il contenuto della tua pagina corrisponde all'intento della query. In altre parole, questa pagina corrisponde alle parole cercate e aiuta a svolgere
        ...
        <section>
            ...
            <p class="text-secondary">RankBrain è il componente di apprendimento automatico dell'<a href="./glossario.html#alg">algoritmo</a> principale di Google. Il Machine learning è un programma per computer che continua a migliorare le sue previsioni nel tempo attraverso
                ...
                Ad esempio, se RankBrain nota un <a href="./glossario.html#url">URL</a> con un ranking più basso che fornisce un risultato migliore agli utenti rispetto agli URL con un ranking più alto, RankBrain regolerà quei risultati, spostando il
    ...
    <aside>
        <h2>Argomenti</h2>
        <ul>
            <li><a href="#primo">Il ruolo dei link nella SEO</a></li>
            <li><a href="#sec">Il ruolo dei contenuti nella SEO</a></li>
            <li><a href="#terzo">Cos'è RankBrain?</a></li>
        </ul>
    </aside>
    `
};
...
const Glossario = {
    ...
    <aside class="scaf">
        <img src="./img/pinpng.com-bookshelf-png-1701154.png" alt="">
    </aside> 
     `,
    methods: {
        getData: function(){
